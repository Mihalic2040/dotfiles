...
print("1.2: Updated Cities List =", cities)
print("1.3: Updated and Sorted List =", sorted_list_2)
print("1.4: String Scientists =", string_scientists)
print("1.5: Merged String =", string_merged)
print("1.6: Sum of Elements > n + 4 =", sum_greater_than_n_plus_4)
